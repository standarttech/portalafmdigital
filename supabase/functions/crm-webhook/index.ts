...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const leadData = {
      ...
      // Facebook attribution fields for CAPI
      fbclid: sanitize(body.fbclid || body.fb_click_id || '', 500) || null,
      fbc: sanitize(body.fbc || '', 500) || null,
      fbp: sanitize(body.fbp || '', 500) || null,
      fb_lead_id: sanitize(body.fb_lead_id || body.leadgen_id || '', 200) || null,
      fb_ad_id: sanitize(body.fb_ad_id || body.ad_id || '', 200) || null,
      fb_adset_id: sanitize(body.fb_adset_id || body.adset_id || body.adgroup_id || '', 200) || null,
      fb_campaign_id: sanitize(body.fb_campaign_id || body.campaign_id || '', 200) || null,
