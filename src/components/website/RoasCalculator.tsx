      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}
            ...
            <div>
              <div className="flex justify-between mb-2">
                <label className="text-sm text-white/70">Conversion Rate</label>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={2}
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-white/[0.05] rounded-xl p-4 sm:p-5">
                <p className="text-white/40 text-[10px] sm:text-xs uppercase tracking-wider mb-1">Est. Revenue</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-extrabold bg-gradient-to-r from-[hsl(42,87%,55%)] to-[hsl(42,87%,70%)] bg-clip-text text-transparent">
                  ${estimatedRevenue.toLocaleString()}
                </p>
              </div>
              <div className="bg-white/[0.05] rounded-xl p-4 sm:p-5">
                <p className="text-white/40 text-[10px] sm:text-xs uppercase tracking-wider mb-1">Est. Profit</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-emerald-400">
                  ${estimatedProfit.toLocaleString()}
                </p>
              </div>
              <div className="bg-white/[0.05] rounded-xl p-4 sm:p-5">
                <p className="text-white/40 text-[10px] sm:text-xs uppercase tracking-wider mb-1">ROAS</p>
                <p className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-[hsl(42,87%,55%)]">
                  {estimatedRoas}%
                </p>
              </div>
              <div className="bg-white/[0.05] rounded-xl p-4 sm:p-5">
                <p className="text-white/40 text-[10px] sm:text-xs uppercase tracking-wider mb-1">Est. Leads</p>
            ...
            <div className="bg-white/[0.03] rounded-xl p-3 sm:p-4 flex items-start gap-2 sm:gap-3">
              ...
              <p className="text-white/50 text-[11px] sm:text-xs leading-relaxed">
                ...
                Actual results may vary. Book a free audit for a personalized estimate.
              </p>
            </div>
          </motion.div>
        </div>
