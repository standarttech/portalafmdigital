    ...
    <section className="py-24 px-6 bg-white/[0.01]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          <div className="bg-white/[0.03] border border-white/10 rounded-2xl overflow-hidden shadow-2xl shadow-black/40">
            ...
            <div className="h-10 bg-white/[0.05] border-b border-white/5 flex items-center px-4 gap-2">
              ...
              <div className="flex-1 mx-4">
                <div className="bg-white/[0.05] rounded-md h-6 max-w-sm mx-auto flex items-center justify-center">
                  <span className="text-white/30 text-[10px]">portal.afmdigital.com</span>
                </div>
              </div>
            </div>
          ...
          {/* Nav arrows */}
          <button onClick={prev}
            className="absolute left-3 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-black/50 backdrop-blur flex items-center justify-center text-white/70 hover:text-white transition-colors">
            <ChevronLeft className="h-5 w-5" />
          </button>
          <button onClick={next}
            className="absolute right-3 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-black/50 backdrop-blur flex items-center justify-center text-white/70 hover:text-white transition-colors">
        ...
        <motion.div key={active} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
          ...
          <p className="text-white/50 text-sm mt-1 max-w-lg mx-auto">{slides[active].desc}</p>
        </motion.div>
      </div>
    </section>
  );
