...
import {
  ...
  ChevronLeft, ChevronRight, UserCircle, LogOut, Menu, X, BookOpen, Calculator, DollarSign, Calendar, MessageSquare, ClipboardList,
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { key: 'nav.tasks' as TranslationKey, icon: ClipboardList, path: '/tasks', section: 'main' },
