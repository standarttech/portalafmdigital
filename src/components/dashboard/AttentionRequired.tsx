        ...
        if (recentMetrics) {
          ...
          Object.entries(byClient).forEach(([clientId, data]) => {
            ...
            if (prevConv > 0 && recentConv > 0 && data.prev.days >= 3) {
              ...
              // === POSITIVE: Cost per conversion drop > 25% ===
            ...
            if (data.prev.days >= 3 && data.recent.days >= 2) {
              ...
              // === POSITIVE: Spend decrease with stable/better conversions ===
            ...
            // === POSITIVE: Conversion volume boost > 30% ===
