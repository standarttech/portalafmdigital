    ...
    <div>
      <section className="py-24 sm:py-32 px-4 sm:px-6 text-center">
        <motion.p initial="hidden" animate="visible" variants={fadeUp} custom={0}
          className="text-[hsl(42,87%,55%)] text-xs sm:text-sm font-semibold tracking-[0.2em] sm:tracking-[0.3em] uppercase mb-3 sm:mb-4">Our Services</motion.p>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-white/[0.01]">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-14">Our <span className="text-[hsl(42,87%,55%)]">Approach</span></h2>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 text-center">
        <Link to="/contact"
          ...
          Get a Free Ads Audit <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5" />
        </Link>
      </section>
    </div>
  );
