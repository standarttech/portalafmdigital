        ...
        <motion.div initial="hidden" animate="visible" className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <motion.div variants={fadeUp} custom={3}>
            <Link to="/contact"
              ...
              Book a Free Ads Audit <ArrowRight className="h-4 w-4 sm:h-5 sm:w-5" />
            </Link>
          </motion.div>
        </motion.div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 grid grid-cols-3 gap-4 sm:gap-8">
          {stats.map((s, i) => (
            <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={i}
              ...
              <p className="text-2xl sm:text-4xl lg:text-5xl font-extrabold bg-gradient-to-r from-[hsl(42,87%,55%)] to-[hsl(42,87%,70%)] bg-clip-text text-transparent">
                {s.value}
              </p>
